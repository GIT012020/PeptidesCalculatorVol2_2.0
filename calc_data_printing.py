...
class Data_Printer:
    ...
    endings = pd.DataFrame({
        'TERMINUS TYPE': ['N-TERMINUS', 'N-TERMINUS', 'N-TERMINUS', 'N-TERMINUS', 'N-TERMINUS', 'N-TERMINUS', 'N-TERMINUS', 'N-TERMINUS', 'N-TERMINUS', 'N-TERMINUS',
        ...
        'TERMINUS NAME': ["Hydrogen", "Biotin", "Acetyl", "5-FAM", "5-TAMRA", "DABCYL", "Fmoc", "Pyr", "Myr",
                          "DOTA", "Free", "Amide", "Aldehyde", "AFC", "CMK", "EDANS"],
        'MOLECULAR WEIGHT': [1.00797, 227.3056, 43.04453, 359.3, 413.44, 252.29, 223.24, 112.1, 211.36, 387.4, 17.00738,
